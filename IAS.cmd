...
::
::   Homepages: https://github.com/Hack_Training/IDM-Activation-Script
::             
::
::       Email: mohan37996@gmail.com
::
::============================================================================
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/Hack_Training/IDM-Activation-Script & start %mas%/idm-activation-script & exit /b)
)
)
...
if %_erl%==6 exit /b
if %_erl%==5 start https://github.com/Hack_Training/IDM-Activation-Script & start https://massgrave.dev/idm-activation-script & goto MainMenu
