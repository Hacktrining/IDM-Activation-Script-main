...
[GitHub](https://github.com/Hack_Training/IDM-Activation-Script) - [BitBucket](https://bitbucket.org/Hack_Training/idm-activation-script/)
...
-   Download the file from [GitHub](https://github.com/Hack_Training/IDM-Activation-Script/archive/refs/heads/main.zip) or [Bitbucket](https://bitbucket.org/Hack_Training/idm-activation-script/get/main.zip)
...
-   Raise the issue on [Github](https://github.com/Hack_Training/IDM-Activation-Script) with screenshots.
...
-   Fixed an issue where Powershell code to launch IAS may not work due to GitHub block in some regions. It will use the new [BitBucket](https://bitbucket.org/Hack_Training/idm-activation-script/) repo as a fallback link.
...
-   Move the project to [Github](https://github.com/Hack_Training/IDM-Activation-Script) and [Hack_Training.dev](https://Hack_Training.dev/idm-activation-script.html)
-   Minor bug fixes
-   Add info to inform users that empty registry keys are being deleted when the script deletes a lot of them

## Screenshots

![](https://Hack_Training.dev/images/IAS.png?raw=true)
